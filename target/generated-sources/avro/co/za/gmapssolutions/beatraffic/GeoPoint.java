...
public class GeoPoint extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5259402387698129338L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"GeoPoint\",\"namespace\":\"co.za.gmapssolutions.beatraffic\",\"fields\":[{\"name\":\"longitude\",\"type\":\"double\"},{\"name\":\"latitude\",\"type\":\"double\"}]}");
   ...
   */
  public static BinaryMessageEncoder<GeoPoint> getEncoder() {
    return ENCODER;
  }
   ...
   * @return a GeoPoint instance decoded from the given buffer
   ...
   */
  public GeoPoint(java.lang.Double longitude, java.lang.Double latitude) {
   ...
   */
  public static co.za.gmapssolutions.beatraffic.GeoPoint.Builder newBuilder() {
    return new co.za.gmapssolutions.beatraffic.GeoPoint.Builder();
  }
   ...
   * @return A new GeoPoint RecordBuilder
   */
  public static co.za.gmapssolutions.beatraffic.GeoPoint.Builder newBuilder(co.za.gmapssolutions.beatraffic.GeoPoint.Builder other) {
    if (other == null) {
      return new co.za.gmapssolutions.beatraffic.GeoPoint.Builder();
    } else {
      return new co.za.gmapssolutions.beatraffic.GeoPoint.Builder(other);
    }
  }
   ...
   * @return A new GeoPoint RecordBuilder
   */
  public static co.za.gmapssolutions.beatraffic.GeoPoint.Builder newBuilder(co.za.gmapssolutions.beatraffic.GeoPoint other) {
    if (other == null) {
      return new co.za.gmapssolutions.beatraffic.GeoPoint.Builder();
    } else {
      return new co.za.gmapssolutions.beatraffic.GeoPoint.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GeoPoint>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(co.za.gmapssolutions.beatraffic.GeoPoint.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(co.za.gmapssolutions.beatraffic.GeoPoint other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.longitude)) {
        this.longitude = data().deepCopy(fields()[0].schema(), other.longitude);
    ...
    /**
      ...
      * @return This builder.
      */
    public co.za.gmapssolutions.beatraffic.GeoPoint.Builder setLongitude(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.za.gmapssolutions.beatraffic.GeoPoint.Builder clearLongitude() {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.za.gmapssolutions.beatraffic.GeoPoint.Builder setLatitude(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public co.za.gmapssolutions.beatraffic.GeoPoint.Builder clearLatitude() {
